...
/*    game.settings.register("TheWitcherTRPG", "useRegularFont", {
        name: "WITCHER.Settings.RegularFont",
        scope: "world",
        config: true,
        type: Boolean,
        default: false
...
/*    game.settings.register("TheWitcherTRPG", "useMedievalFont", {
        name: "WITCHER.Settings.medievalFont",
        scope: "world",
        config: true,
        type: Boolean,
        default: false
